  ...
  "barbeau-meridional": {
    ...
    bio: {
      rows: [
        ...
        ["Statut", "Quasi menacé (UICN NT, 2023) ; protégé et inscrit à l'annexe II de la Directive Habitats"],
      ],
    },
  },
  ...
  blageon: {
    ...
    bio: {
      rows: [
        ...
        ["Statut", "Préoccupation mineure au niveau mondial (UICN LC, 2023) mais inscrit à l'annexe II de la Directive Habitats — protégé en France"],
      ],
    },
  },
  ...
  toxostome: {
    ...
    bio: {
      rows: [
        ...
        ["Statut", "Quasi menacé (UICN NT, 2023) ; protégé, annexe II de la Directive Habitats. Menacé notamment par l'hybridation avec le hotu introduit"],
      ],
    },
  },
  ...
  "vandoise-rostree": {
    ...
    bio: {
      rows: [
        ...
        ["Statut", "Quasi menacé (UICN NT, 2023). Décrite en 2002 par scission de la vandoise commune"],
      ],
    },
  },
  ...
  "vandoise-du-bearn": {
    ...
    bio: {
      rows: [
        ...
        ["Statut", "Quasi menacé (UICN NT, 2023, critère B1b(iii)) — une aire minuscule est sa principale fragilité"],
      ],
    },
  },
  ...
  "chevesne-catalan": {
    ...
    bio: {
      rows: [
        ...
        ["Statut", "Vulnérable (UICN VU, 2023). Menacé d'introgression par le chevesne commun là où les deux se rencontrent"],
      ],
    },
  },
  ...
  "goujon-occitan": {
    ...
    bio: {
      rows: [
        ...
        ["Statut", "Préoccupation mineure (UICN LC, 2023)"],
      ],
    },
  },
  ...
  vimbe: {
    ...
    bio: {
      rows: [
        ...
        ["Statut", "Préoccupation mineure (UICN LC, 2022)"],
      ],
    },
  },
  ...
  "goujon-de-l-adour": {
    ...
    bio: {
      rows: [
        ...
        ["Statut", "Quasi menacé (UICN NT, 2023)"],
      ],
    },
  },
  ...
  "vandoise-au-long-museau": {
    ...
    bio: {
      rows: [
        ...
        ["Statut", "Préoccupation mineure (UICN LC)"],
      ],
    },
  },
  ...
  "breme-du-danube": {
    ...
    bio: {
      rows: [
        ...
        ["Statut", "Non applicable (UICN NA) — espèce introduite"],
      ],
    },
  },
  ...
  "carpe-koi-sauvage": {
    ...
    bio: {
      rows: [
        ...
        ["Statut", "Préoccupation mineure (UICN LC, 2020)"],
      ],
    },
  },
  ...
  "rotengle-italien": {
    ...
    bio: {
      rows: [
        ...
        ["Statut taxonomique", "Espèce distincte du rotengle commun (Scardinius erythrophthalmus), reconnue depuis 1845"],
      ],
    },
  },
};
