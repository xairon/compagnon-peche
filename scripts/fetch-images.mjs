...
console.log(
  `\nWrote src/data/media.ts — ${Object.keys(speciesMedia).length} species, ${Object.keys(knotMedia).length} knots, ${Object.keys(knotStepMedia).length} knot-step-sequences, ${Object.keys(recipeMedia).length} recipes, ${Object.keys(techMedia).length} techniques, ${Object.keys(gearMedia).length} gear.`,
);
